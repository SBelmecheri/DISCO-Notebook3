...
Gst (or Γ*, Gamma Star) is the CO2 compensation point in the absence of mitochondrial respiration (Pa), it is calculated from the temperature (T) and atmospheric pressure response.You can use the gammastar(tc, patm) function from the rpmodel to calculate Gamma Star.
...
ts.plot(ci.leaf/ca,ylab="ci/ca",xlab="Years", main="") 
# add linear trend
...
ci.leaf.photo.ppm <- ci.leaf.photo /(( 1.e-6 ) * patm)
