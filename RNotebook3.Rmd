...
You will need to download the R project fromchttps://github.com/SBelmecheri/DISCO-Ntebook3.git and to set your own working directory. Once you open the Notebook 3.Rproj in R studio  you can open the Notebook3.Rmd file to proceed with the activity.
