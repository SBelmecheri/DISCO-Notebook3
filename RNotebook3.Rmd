...
library("rpmodel")
```
and the function `calc_patm {rpmodel}` to calculate atmospheric pressure at sea level as function of elevation (site elevation).
```{r}
...
This correction can be made as follows: WARNING** Choose the appropriate d factor for this site**
```{r}
